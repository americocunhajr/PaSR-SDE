...
%  implicit Milstain-Taylor algorithm (Sabelnikov 2001).
%
%   Input :
%       dt              :   time step
...
%       f_kf(npd,nsv)   :   particle-independent scalars
% -----------------------------------------------------------------
function f_kf = ExtLangevin_MT(dt,ncell,omean_cell,...
    ...
    for lc = 1:1:ncell
        ...
        for i = nf(lc):1:nl(lc)                 
            ...
            % EXTENDED LANGEVIN MODEL VIA IMPLICIT Milstain-Taylor METHOD
